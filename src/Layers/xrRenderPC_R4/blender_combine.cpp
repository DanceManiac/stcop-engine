...
void	CBlender_combine::Compile(CBlender_Compile& C)
{
	...
	case 2:	// non-AA + DISTORTION
		//	Can use simpler VS (need only Tex0)
		C.r_Pass("stub_screen_space","combine_2_dist", FALSE, FALSE, FALSE);
...
void	CBlender_combine_msaa::Compile(CBlender_Compile& C)
{
   ...
   case 1:	// non-AA
      //	Can use simpler VS (need only Tex0)
      C.r_Pass("stub_screen_space","combine_2", FALSE, FALSE, TRUE);
   ...
   case 2:	// non-AA + DISTORTION
      //	Can use simpler VS (need only Tex0)
      C.r_Pass("stub_screen_space","combine_2_dist", FALSE, FALSE, TRUE);
