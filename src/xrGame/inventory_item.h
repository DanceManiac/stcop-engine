...
public:
	...
	bool    upgrade_addon_check			(shared_str addon_name, bool install);
 shared_str get_upgrade_name_by_addon	(shared_str addon_name);
	void	add_upgrade					( const shared_str& upgrade_id, bool loading );
	void	remove_upgrade				( const shared_str& upgrade_id, bool loading, bool spawn_item);
